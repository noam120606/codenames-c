...
\begin{document}
    ...
    \title{
        ...
        \textbf{Codenames}\\
        Repo git : https://github.com/noam120606/codenames-c
    }
                ...
                \item Déroulement d’un tour
                    ...
                    \begin{enumerate}
                        ...
                        \item Phase de devinettes
                            ...
                            → L’équipe doit proposer au minimum 2 mots mais peu en proposer jusqu’à 3 mots.
    ...
    \label{sec:developpement}
        ...
        \begin{itemize}
            ...
            \item affiche la latence (ping serveur) et les performances du jeu (FPS).
        \end{itemize}
